const actionlist = [
  ...
  },
  {
    ...
    description: "<p>Heal yourself or another target.</p><p><i>(Single) </i>Heal 1 target for the full amount</p><p><i>(AoE) </i>Split your heal amount equally among three targets, rounded down.</p>",
    dice: "1d20 + modifiers",
  ...
  },
  {
    ...
    description: "<p>Grant yourself or another target a damage buff.</p><p><i>(Single) </i>Give one target a damage buff that lasts 3 posts</p><p><i>(AoE) </i>Give three targets a damage buff that lasts for 1 post.</p>",
  ...
  },
  {
    ...
    description: "<p><i>(Special Action)</i></p><p>Heal yourself or another target.<p>This is a more potent heal with dangerous drawbacks.</p><p>Gain the Vulnerable status. If you roll a nat100, double your total after adding modifiers.</p><p><i>(Single) </i>Heal 1 target for the full amount</p><p><i>(AoE) </i>Split your heal amount equally among three targets, rounded down.</p>",
    dice: "1d100 + modifiers",
  ...
  },
  {
    ...
    description: "<p><i>(Special Action)</i></p><p>Grant yourself or another target a damage buff.This is a more potent buff with dangerous drawbacks.</p><p>Gain the Vulnerable status.</p><p><i>(Single) </i>Give one target a damage buff that lasts 3 posts</p><p><i>(AoE) </i>Give three targets a damage buff that lasts for 1 post.</p>",

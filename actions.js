const actionlist = [
  ...
  },
  {
    ...
    description: "<p>Attack and hinder the target. Half of the attack's final roll result reduces the target's HP, the other half reduces the target's stability/SP.</p><p><i>This action can be flavored as a spell or ability that crowd control (CC) the enemy such as entanglement, cripple, slow, disrupt, trap, etc.</i></p>",
    dice: "1d100 + modifiers",
  ...
  },
  {
    ...
    description: "<p>Attack a target and give 1 nearby ally the Protected status.</p><p><i>This action can be flavored as a taunt that draws enemy attention away to reduce damage, an ability or spell that damages enemy and boost your ally's defense, or an ability that stops enemy from getting close to the ally, etc.</i></p>",
    dice: "2d20 + modifiers",
  ...
  },
  {
    ...
    description: "<p><i>(Special Action)</i></p><p>Perform a big attack and majorly hinder the target at the cost of your own safety.Half of the attack's final roll result reduces the target's HP, the other half reduces the target's Stability. Gain the Vulnerable status.</p><p><i>This action can be flavored as a spell or ability that crowd control (CC) the enemy such as entanglement, cripple, slow, disrupt, trap, etc.</i></p>",
